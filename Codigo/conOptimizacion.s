...
; PASO 1: SUMA DE MATRICES A + B Y CÁLCULO DEL DETERMINANTE MEDIANTE LAPLACE
		...
		multf f18, f0, f9 ; EMPIEZA LAS OPERACIONES DE MULTIPLICACION A X B
            ...
            lf f28, cero ; Cargar el 0
            lf f31, unoFloat; Cargar el 1

            
	      multf f19, f1, f12 ; EMPIEZA LAS OPERACIONES DE MULTIPLICACION A X B
            addf f30, f26, f20 ; (PRIMER MENOR - SEGUNDO MENOR) + TERCER MENOR ¡¡¡ DETERMINANTE REGISTRO F30 !!!
...
; PASO 2: DIVISIÓN DE 1 / |A + B| Y COMPROBACIÓN SI ES 0 O NO
            ...
            eqf f30, f28 ; Comprobamos si el determinante es 0
            bfpt end ; Finalizamos el programa si el determinante es 0
            
            
            divf f31, f31, f30 ; Division 1 / det A + B
...
; PASO 3: MULTIPLICACION DE LAS MATRICES A X B
            ...
            multf f24, f0, f11
            addf f19, f19, f23
	      divf f18, f18, f30 ;DIVISIÓN DE LAS MATRICES A X B ENTRE / |A + B| Y CARGA MATRIZ C Y alfa
            ...
            multf f23, f5, f15
	      divf f19, f19, f30 ;DIVISIÓN DE LAS MATRICES A X B ENTRE / |A + B| Y CARGA MATRIZ C Y alfa
            addf f21, f21, f22
            ...
            multf f27, f3, f11
            addf f23, f23, f29
	      divf f20, f20, f30 ;DIVISIÓN DE LAS MATRICES A X B ENTRE / |A + B| Y CARGA MATRIZ C Y alfa
            multf f28, f4, f14
	      ...
	      divf f21, f21, f30 ;DIVISIÓN DE LAS MATRICES A X B ENTRE / |A + B| Y CARGA MATRIZ C Y alfa
            multf f27, f6, f10
            multf f28, f7, f13
            addf f24, f24, f26
            multf f29, f8, f16
	      ...
	      divf f22, f22, f30 ;DIVISIÓN DE LAS MATRICES A X B ENTRE / |A + B| Y CARGA MATRIZ C Y alfa
            multf f1, f8, f17
            multf f0, f7, f14
            addf f26, f26, f1
...
; PASO 4: DIVISIÓN DE LAS MATRICES A X B ENTRE / |A + B| Y CARGA MATRIZ C Y alfa
